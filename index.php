        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class='btn btn-success' href="cargar.php?id=<?php echo $id; ?>"><?php echo $valor ;?> descargar</a></td>
                    <td><?php echo $fecha ;?></td>
                    <td>
                        <a class='btn btn-secondary' href="editar.php?id=<?php echo $id?>">Editar</a>
                        <a class='btn btn-danger' href="controllers/eliminar.php?id=<?php echo $id?>">Eliminar</a>
                    </td>
                </tr>
                <?php 
                    }
